...
| 3 — Production surfaces refinement | in progress | 0 | 367 / 42 | clean | Prod list-item badges (SessionListItem LIVE/WIN/LOSS/EVEN, GroupListItem role) → unified Chip (prod-visible, logged). Screen-level prod redesigns (Home/Stats/Session/Profile) remain — review-gated per screen. |
